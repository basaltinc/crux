    ...
    return (
      <ResourcePage>
        ...
        <p>
          ...
          part of I suggest using a combination of photos that depict the
          natural world, photos that use repetitive geometric and natural
          patterns, and photos that depict a potential user in situation.
        </p>
        <img
          src={PhotographyExamples}
